...
namespace RPP
{
    ...
    {
        // Получаем первое предположение о позе
        if (Rlu.data) {
        ...
        // Улучшаем решение методом наименьших квадратов
        int bestIdx = -1;
...
{
    Mat P = _P.clone(); // make a copy, else _P will get modified
